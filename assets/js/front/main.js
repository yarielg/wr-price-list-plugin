   ...
   /* jQuery(document).ready(function(){
       ...
       // div_availability.css('display','none');
        ...
        function get_user_real_price(sku,price_list_user){
            ...
            if(price_list_user.attr('user_id')!="0" || price_list_user.attr('user_id')!=0){
                ...
                quest_container_simple_price.html('<span class="woocommerce-Price-currencySymbol" style="font-size:11px;">Login please!</span>');
            }
        }
