<!-- Modal -->
<div class="modal fade" id="wrpl_edit_role_modal" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group row ml-3 mb-2">
                            ...
                            <input type="text" name="wrpl_role_name" id="wrpl-edit-role" class="form-control col-9" required min="3" max="100">
